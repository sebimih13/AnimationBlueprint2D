	...
	, CheckerboardTexture(nullptr)
{
	...
	// TODO : SET IN Paper2DAnimation Module
	FVector PaperAxisX = FVector(1.0f, 0.0f, 0.0f);
	FVector PaperAxisY = FVector(0.0f, 0.0f, 1.0f);
	FVector PaperAxisZ = FVector::CrossProduct(PaperAxisX, PaperAxisY);
